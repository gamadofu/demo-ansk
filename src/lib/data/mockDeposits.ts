...
export const mockDeposits: Deposit[] = [
  ...
  },
  {
    deposit_id: '11',
    customer_id: '4',
    deposit_date: '2025-03-10T14:20:00Z',
    week_number: 11,
    week_type: 'consumption',
    amount_jpy: 10800,
    yuan_conversion: 500,
    exchange_rate: 21.60,
    remaining_yuan: 1749.21,
    remaining_jpy: 39200,
    note: '商品購入',
  ...
  },
  {
    ...
    week_type: 'consumption',
    amount_jpy: 22000,
    yuan_conversion: 1000,
    exchange_rate: 22.00,
    remaining_yuan: 2542.96,
    remaining_jpy: 58000,
    note: '商品購入',
